...
export default function Gallery({ images, model }: GalleryProps) {
    ...
    return (
        <div className="mb-8 lg:mb-0">
            {/* Desktop Main Image */}
            <div
                className="hidden lg:block relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-gray-100 mb-4 shadow-sm border border-gray-100 group cursor-zoom-in"
            ...
            <div className="lg:hidden relative">
                ...
                >
                    {images.map((img, index) => (
                        <div
                            key={index}
                            className="relative flex-shrink-0 w-full aspect-[4/3] snap-center rounded-xl overflow-hidden bg-gray-100 shadow-sm"
