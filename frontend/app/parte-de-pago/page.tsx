            ...
            <div className="relative h-[500px] md:h-[600px] bg-black text-white overflow-hidden flex items-center justify-center">
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 drop-shadow-2xl">
                        Tu auto en <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#FFF5D1] via-[#D4AF37] to-[#8A6E2F] filter brightness-125">Parte de Pago</span>
                    </h1>
                    <p className="text-xl md:text-3xl font-light text-gray-200 max-w-3xl mx-auto leading-relaxed drop-shadow-lg">
                        Déjanos tu vehículo en parte de pago o en consignación. Proceso seguro y transparente.
                    </p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-8 sticky top-24">
                        ...
                        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 relative overflow-hidden group hover:border-black transition duration-300">
                            ...
                            <h3 className="text-xl font-black uppercase mb-4 pr-16">Parte de Pago</h3>
                            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                                Deja tu auto antiguo como parte de pago y llévate un seminuevo Carmona. Tasación profesional y competitiva.
                            </p>
                            <ul className="text-sm space-y-2 text-gray-500">
                                <li className="flex items-center gap-2"><i className="fa-solid fa-check text-green-500"></i> Tasación en 30 minutos</li>
                                <li className="flex items-center gap-2"><i className="fa-solid fa-check text-green-500"></i> Transferencia en notaría</li>
                                <li className="flex items-center gap-2"><i className="fa-solid fa-check text-green-500"></i> Pago seguro</li>
                            </ul>
                        </div>
